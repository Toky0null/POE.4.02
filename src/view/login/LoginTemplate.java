...
public class LoginTemplate extends JFrame {
  ...
  public void crearObjetosDecoradores() {
    iFondo = new ImageIcon(getClass().getResource("/view/img/fondo.png"));
    iLogo = new ImageIcon(getClass().getResource("/view/img/logo.png"));
    iAbajo = new ImageIcon(getClass().getResource("/view/img/abajo.png"));
    iUsuario1 = new ImageIcon(getClass().getResource("/view/img/usuario1.png"));
    iUsuario2 = new ImageIcon(getClass().getResource("/view/img/usuario2.png"));
    iClave1 = new ImageIcon(getClass().getResource("/view/img/clave1.png"));
    iClave2 = new ImageIcon(getClass().getResource("/view/img/clave2.png"));
    iPunto1 = new ImageIcon(getClass().getResource("/view/img/punto1.png"));
    iPunto2 = new ImageIcon(getClass().getResource("/view/img/punto2.png"));
    iFacebook1 = new ImageIcon(getClass().getResource("/view/img/facebook1.png"));
    iFacebook2 = new ImageIcon(getClass().getResource("/view/img/facebook2.png"));
    iTwitter1 = new ImageIcon(getClass().getResource("/view/img/twitter1.png"));
    iTwitter2 = new ImageIcon(getClass().getResource("/view/img/twitter2.png"));
    iYoutube1 = new ImageIcon(getClass().getResource("/view/img/youtube1.png"));
    iYoutube2 = new ImageIcon(getClass().getResource("/view/img/youtube2.png"));
    iSvg1 = new ImageIcon(getClass().getResource("/view/img/imagen1.png"));
    iSvg2 = new ImageIcon(getClass().getResource("/view/img/imagen2.png"));
    iSvg3 = new ImageIcon(getClass().getResource("/view/img/imagen3.png"));
  }
  ...
  public void crearJLabels() {
    ...
    iDimAux = new ImageIcon(
      iSvg1.getImage()
        .getScaledInstance(450, 345, Image.SCALE_AREA_AVERAGING)
    );
