...
public class RecursosService {
  ...
  private void crearImagenes() {
    iCerrar = new ImageIcon(getClass().getResource("/view/img/cerrar.png"));
    iMinimizar = new ImageIcon(getClass().getResource("/view/img/minimizar.png"));
  }
